...
public class ApiClient {
    ...
    private String basePath = "https://production.plaid.com";
    ...
    public ApiClient() {
        ...
        authentications.put("clientId", new ApiKeyAuth("header", "PLAID-CLIENT-ID"));
        authentications.put("plaidVersion", new ApiKeyAuth("header", "Plaid-Version"));
        authentications.put("secret", new ApiKeyAuth("header", "PLAID-SECRET"));
    ...
    private void init() {
        ...
        setUserAgent("OpenAPI-Generator/2020-09-14_1.64.13/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://production.plaid.com
